...
cd $folder;
for i in `seq 0 2 967`; do echo "HAPCUT - $i"; ../../scripts/hapcutVcf.sh hap_$i.linkedReads.diploid.$tag.bam stitch.Herato1603.3450000.3550000.PL.reheadered.vcf.gz $tag; done
